...
namespace PlayerControls.Controls.windows
{
	...
	{
		public ScheduledFramesPresenterWindow(string title, IScheduledFrame[] itemsSource)
		{
			...
			CsGlobal.Wpf.Storage.Window.Handle(this, $"{nameof(ScheduledFramesPresenterWindow)}");
		}
	}
}